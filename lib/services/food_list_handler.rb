...
module Services
  class FoodListHandler
    ...
    RECIPE_URL = 'http://www.aarstiderne.com/Opskrifter/Menuoversigt?&persons=2&days=3&d='
    ...
    def get_food_items(date)
      ...
      res = Net::HTTP.post_form(uri, itemNo: 115064, shipmentDate: date)
    ...
    def get_recipes(date)
      ...
      meals = doc.xpath('//div[@data-family-type="LowCarb" and @data-days="3" and @data-persons="2"][1]//div[@class="meals"]/a')
